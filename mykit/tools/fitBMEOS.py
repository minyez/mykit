...
from mykit.core.eos import eos
...
if not args.fbp:
    Bp = 4.0
    popt, pcov = curve_fit(eos.Birch_Murnaghan, data[0], data[1], p0=[E0, V0, B0, Bp])
    Bp = popt[3]
else:
    Bp = args.fbp
    popt, pcov = curve_fit(lambda V, E0, V0, B0: eos.Birch_Murnaghan(V, E0, V0, B0, Bp), \
...
yfit = eos.Birch_Murnaghan(xfit, popt[0], popt[1], popt[2], Bp)
