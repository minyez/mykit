...
- Special kpoints are retrieved from [Bilbao Crystallographic Server](http://www.cryst.ehu.es), explicitly the `KVEC` program. Citations: [Aroyo2014](https://dx.doi.org/10.1107/S205327331303091X) and [Tasci2012](https://dx.doi.org/10.1051/epjconf/20122200009)
