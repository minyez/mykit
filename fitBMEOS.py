...
# Four argument is needed: data file, number of formula units, E0 and V0. The last two can be extracted by figuring out the lowest point among the data, if not specified.
# Birch-Murnaghan Equation of State, E0,V0,B and Bp are parameters
